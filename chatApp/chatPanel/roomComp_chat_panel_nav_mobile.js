...
__SYD.chat_main_tab_2_nav_mobile = () =>{
    ...
    return __c(
        "div",
        {
            style:`height:fit-content;width:fit-content;background:${SYD_VAR.sand};position:absolute;bottom:10px;left:50%;transform:translateX(-50%);padding:5px 15px;display:${!mainCheck && !mainCheck2 ? 'flex' : 'none'};column-gap:40px;align-items:center;` + __sC['b_rad_18']() + __sC['signUp_model_shadow']()
        },
        [
            __c(
                'div',
